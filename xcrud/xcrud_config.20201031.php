...
class Xcrud_config
{
    ...
    public static $dbname = 'xtremelashes_com_hk'; // Your database name
    public static $dbuser = 'xtremelashe_adm'; // Your database username
    public static $dbpass = '!aN7M6&y'; // // Your database password
    public static $dbhost = 'mysql.xtremelashes.com.hk'; // Your database host, 'localhost' is default.
