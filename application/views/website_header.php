...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-WV686D7');
  </script>
  ...
  <!-- 1001  fonts -->
  <link rel="stylesheet" href="https://www.1001font
  s.com/">
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WV686D7" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->

  <!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top py-3">
    <div class="container-fluid ">
      <a href="<?php echo base_url() ?><?php if ($this->session->userdata('site_lang') == 'cn') {
                                          echo 'cn/';
                                        } ?>"><img src="<?php echo base_url() ?>website_assets/images/home/logo.png" alt="Xtreme Lashes HK Logo" class="img-responsive logo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav gotham-book ml-auto">
          ...
          foreach ($menus as $menu) { ?>
            ...
            <li style="font-size:14px" class="nav-item <?php if ($this->uri->segment(1) == 'aboutus') {
                                                          echo 'active';
                                                        } ?>">
              <a class="nav-link " href="<?php echo base_url() ?><?php if ($this->session->userdata('site_lang') == 'cn') {
                                                                    echo 'cn/';
                                                                  } ?><?php echo get_page_slug($menu->page_id) ?>"><?php
